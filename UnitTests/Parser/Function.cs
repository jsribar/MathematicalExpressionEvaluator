...
namespace Parser
{
    ...
    public class Function
    {
        ...
        public void ParserReturnsExpressionForSinFunctionWithConstantArgument()
        {
            ...
            Assert.AreEqual(1, parser.Parse("sin(1.5707963267948966192313216916398)").Evaluate(5), 1e-10);
        }
        ...
        {
            var parser = new MathematicalExpressionEvaluator.Parser();
            Assert.AreEqual(1, parser.Parse("sin(x)").Evaluate(1.5707963267948966192313216916398), 1e-10);
        }
        ...
        {
            var parser = new MathematicalExpressionEvaluator.Parser();
            Assert.AreEqual(1, parser.Parse("sin(x + 1)").Evaluate(0.5707963267948966192313216916398), 1e-10);
            Assert.AreEqual(3, parser.Parse("sqrt(11 - x * 2)").Evaluate(1), 1e-10);
        }
        ...
        {
            var parser = new MathematicalExpressionEvaluator.Parser();
            Assert.AreEqual(-4, parser.Parse("sqrt(4) - sqrt(9) * 2").Evaluate(2), 1e-10);
            Assert.AreEqual(Math.Sqrt(2), parser.Parse("3 * sqrt(x) - sqrt(x) * 2").Evaluate(2), 1e-10);
            Assert.AreEqual(2, parser.Parse("sin(x / 2) + cos(2 * x)").Evaluate(3.1415926535897932384626433832795), 1e-10);
            Assert.AreEqual(2, parser.Parse("sin((2 * x) / (2 + 2)) - cos(x - 2 * x)").Evaluate(3.1415926535897932384626433832795), 1e-10);
            Assert.AreEqual(-1, parser.Parse("sin((2 * x) / (2 + 2)) * cos(x - 2 * x)").Evaluate(3.1415926535897932384626433832795), 1e-10);
        }
        ...
        {
            var parser = new MathematicalExpressionEvaluator.Parser();
            Assert.AreEqual(Math.Sqrt(2), parser.Parse("sqrt(sin(x / 2) + cos(2 * x))").Evaluate(3.1415926535897932384626433832795), 1e-10);
        }
        ...
        {
            var parser = new MathematicalExpressionEvaluator.Parser();
            Assert.AreEqual(-Math.Sqrt(2), parser.Parse("-sqrt(2)").Evaluate(3.1415926535897932384626433832795), 1e-10);
        }
